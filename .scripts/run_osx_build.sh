...
validate_recipe_outputs "pytorch_spline_conv-feedstock"

if [[ "${UPLOAD_PACKAGES}" != "False" ]]; then
  echo -e "\n\nUploading the packages."
  upload_package --validate --feedstock-name="pytorch_spline_conv-feedstock" ./ ./recipe ./.ci_support/${CONFIG}.yaml
fi